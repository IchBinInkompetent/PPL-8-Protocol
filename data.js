    ...
    cycleA: [
        {
            ...
            exercises: [
                {
                    id: "a1e1", name: "DB Incline Press", sets: 2, reps: "8-12", tempo: "3-1-1-0", restSeconds: 90, note: "Max. 32kg. 1 Sek. Dead-Stop im tiefen Stretch.",
                ...
                {
                    id: "a1e2", name: "Low-to-High Cable Crossovers", sets: 2, reps: "10-12", tempo: null, restSeconds: 60, note: "Pectoralis über die Mittellinie verkürzen.",
                ...
                {
                    id: "a1e3", name: "Butterfly Maschine", sets: 2, reps: "8-10", tempo: null, restSeconds: 60, note: "Nach Versagen: Partielle Reps im Stretch (Stretch-Mediated).",
                ...
                {
                    id: "a1e4", name: "Machine Lateral Raises", sets: 2, reps: "10-12", tempo: null, restSeconds: 60, note: "Krafteinleitung am Ellenbogen zur Hebelreduktion.",
                ...
                {
                    id: "a1e5", name: "Overhead Cable Extensions", sets: 2, reps: "10-15/Arm", tempo: null, unilateral: true, restSeconds: 60, note: "Long Head Bias. Einarmig ausführen.",
                ...
                {
                    id: "a1e6", name: "Hanging Leg Raises", sets: 2, reps: "max", tempo: null, isBodyweightOnly: true, restSeconds: 60, note: "Bis technisches Versagen. Kick-Prep.",
        ...
        },
        {
            ...
            exercises: [
                {
                    id: "a2e1", name: "Tuck Front Lever Holds", sets: 3, reps: "5-10 Sek.", tempo: null, isBodyweightOnly: true, restSeconds: 120, note: "Skill-Work bei frischem ZNS.",
                ...
                {
                    id: "a2e2", name: "Explosive High Pull-Ups", sets: 4, reps: "3", tempo: null, isBodyweightOnly: true, restSeconds: 120, note: "Nur Körpergewicht. Fokus: RFD / Speed.",
                ...
                {
                    id: "a2e3", name: "Straight-Arm Cable Pulldowns", sets: 2, reps: "10-12", tempo: null, restSeconds: 60, note: "Latissimus Sweep (Shortened Position).",
                ...
                {
                    id: "a2e4", name: "Chest-Supported Row (breiter Griff)", sets: 2, reps: "8-10", tempo: null, restSeconds: 60, note: "Thoracic Bias (Rhomboiden, Mid-Trap). Technogym.",
                ...
                {
                    id: "a2e5", name: "Single-Arm Cable Iliac Pulldown", sets: 2, reps: "10-12/Seite", tempo: null, unilateral: true, restSeconds: 60, note: "Fokus auf den V-Taper Cut.",
        ...
        },
        {
            ...
            exercises: [
                {
                    id: "a3e1", name: "B-Stance RDLs (DB/Landmine)", sets: 2, reps: "6-8 / 8-10", tempo: null, restSeconds: 90, note: "1x Top-Set, 1x Back-off. Ersetzt Trap Bar – kein ISG-Stress.",
                ...
                {
                    id: "a3e2", name: "Kontralaterale Bulgarian Split Squats (DB)", sets: 2, reps: "8-10/Bein", tempo: null, restSeconds: 90, note: "Anti-Rotation fürs Becken.",
                ...
                {
                    id: "a3e3", name: "Technogym Leg Press (Füße tief)", sets: 2, reps: "10-15", tempo: null, restSeconds: 60, note: "Quad Sweep.",
                ...
                {
                    id: "a3e4", name: "Seated Calf Raises", sets: 2, reps: "12-15", tempo: null, restSeconds: 60, note: "Soleus / Achilles-Prep.",
                ...
                {
                    id: "a3e5", name: "Ab-Wheel Rollouts", sets: 2, reps: "8-12", tempo: null, isBodyweightOnly: true, restSeconds: 60, note: "Anti-Extension.",
    ...
    cycleB: [
        {
            ...
            exercises: [
                {
                    id: "b5e1", name: "Depth Jumps (Dunk-Prep)", sets: 4, reps: "3", tempo: null, isBodyweightOnly: true, restSeconds: 120, note: "Neural Primer. PAP fernab des Beintrainings.",
                ...
                {
                    id: "b5e2", name: "Milon Bankdrückmaschine", sets: 2, reps: "All-Out", tempo: null, acl_warning: true, restSeconds: 120, note: "100% Konz. / 130% Exz. ROM-Restriktion im Stretch!",
                ...
                {
                    id: "b5e3", name: "Flat DB Press", sets: 2, reps: "8-12", tempo: null, restSeconds: 90, note: "Max. 32kg.",
                ...
                {
                    id: "b5e4", name: "Machine Shoulder Press", sets: 2, reps: "8-12", tempo: null, restSeconds: 60, note: "Anterior Bias.",
                ...
                {
                    id: "b5e5", name: "Unilateral Cable Pushdowns", sets: 2, reps: "10-15/Arm", tempo: null, unilateral: true, restSeconds: 60, note: "Cross-Body oder Straight. Ellenbogen-Alignment bei 2.00m.",
                ...
                {
                    id: "b5e6", name: "Milon Crunchmaschine", sets: 2, reps: "All-Out", tempo: null, restSeconds: 120, note: "130% Exzentrik.",
        ...
        },
        {
            ...
            exercises: [
                {
                    id: "b6e1", name: "Milon Rudermaschine", sets: 2, reps: "All-Out", tempo: null, restSeconds: 120, note: "100% Konz. / 130% Exz. Skapula-Retraktion halten!",
                ...
                {
                    id: "b6e2", name: "Neutral Grip Pulldowns (Technogym)", sets: 2, reps: "8-10", tempo: null, restSeconds: 60, note: "Lat Width.",
                ...
                {
                    id: "b6e3", name: "Kelso Shrugs (Chest-Supported)", sets: 2, reps: "10-12", tempo: null, restSeconds: 60, note: "Axial kompressionsfreier Trapezius-Overload.",
                ...
                {
                    id: "b6e4", name: "Decline Reverse Crunches", sets: 2, reps: "max", tempo: null, isBodyweightOnly: true, restSeconds: 60, note: "4-5 Sek. Exzentrik. LWS-sicher für Front Lever.",
        ...
        },
        {
            ...
            exercises: [
                ...
                {
                    id: "b7e2", name: "Milon Beinbeuger (Seated Leg Curl)", sets: 2, reps: "All-Out", tempo: null, restSeconds: 120, note: "130% Exzentrik. Bremskraft-Aufbau für High Kicks!",
                ...
                {
                    id: "b7e3", name: "Milon Beinstrecker", sets: 2, reps: "All-Out", tempo: null, acl_warning: true, restSeconds: 120, note: "130% Exz. ROM-LIMITIERUNG am tiefsten Punkt!",
                ...
                {
                    id: "b7e4", name: "45-Degree Back Extension", sets: 2, reps: "10-15", tempo: null, restSeconds: 60, note: "Hamstring Lengthened Position.",
                ...
                {
                    id: "b7e5", name: "Cable Woodchoppers / Pallof Press", sets: 2, reps: "10-12/Seite", tempo: null, restSeconds: 60, note: "Core-Rotation für Kicks.",
